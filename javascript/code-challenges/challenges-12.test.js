...
const validatePin = (pin) => {
  // Solution code here...
  let regex1 = /[a-z]/g
  let firstBoolean = regex1.test(pin)
...
const validateWord = (word) => {
  // Solution code here...
  let regex1 = /[0-9]/g
  let firstBoolean = regex1.test(word)
  if (firstBoolean === false){
...
const hasNumber = (string) => {
  // Solution code here...
  let regex1 = /\b[a-zA-Z]/g
  
  let firstTest = regex1.test(string)
 
  if(firstTest === true ){
let regex2 = /[0-9]/g
let secondTest = regex2.test(string)
if(secondTest){
  return true
}else{
  return false}
